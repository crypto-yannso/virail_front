...
import { ListChecks, MoreVertical, Clock, Plus } from 'lucide-react';
...
const ContentQueue = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      <button className="w-full mt-4 py-2 
                     border border-dashed border-gray-300 dark:border-border-dark 
                     rounded-lg 
                     text-gray-500 dark:text-text-secondary
                     hover:border-primary hover:text-primary 
                     dark:hover:border-accent-blue dark:hover:text-accent-blue
                     hover:bg-primary/5 dark:hover:bg-accent-blue/5
